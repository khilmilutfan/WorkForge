		...
		<div class="home-content">
			<div class="form-login">
				<form action="">
					...
					<input class="input" type="text" name="Tips loker" id="Tips loker" placeholder="Tips loker" />
					<label for="Work being done">Work being done</label>
					<input class="input" type="text" name="Work being done" id="Work being done" placeholder="Work being done" />
